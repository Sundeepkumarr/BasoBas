...
const footerLinks = {
  ...
  properties: [
    { label: 'Buy Property', href: '/properties?priceType=SALE' },
    { label: 'Rent Property', href: '/properties?priceType=RENT' },
    { label: 'Land', href: '/properties?category=LAND' },
    { label: 'House', href: '/properties?category=HOUSE' },
    { label: 'Apartment', href: '/properties?category=APARTMENT' },
  ],
  support: [
    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              ...
              <p className="flex items-center gap-2 text-sm text-gray-400">
                <HiOutlineLocationMarker className="w-4 h-4" /> Kathmandu, Nepal
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.label}>
                  <Link to={link.href} className="text-sm text-gray-400 hover:text-primary-400 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Properties */}
          <div>
            <h4 className="text-sm font-semibold text-white mb-4 uppercase tracking-wider">Properties</h4>
            <ul className="space-y-3">
