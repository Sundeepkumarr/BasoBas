        ...
        <div className="card overflow-hidden">
          ...
          <div className="relative aspect-[4/3] overflow-hidden">
            ...
            <div className="absolute top-3 left-3 flex gap-2">
              {property.isFeatured && (
                <span className="px-2.5 py-1 rounded-lg bg-accent/90 text-white text-[11px] font-semibold backdrop-blur-sm">
                  ⭐ Featured
                </span>
              )}
              {property.isVerified && (
            ...
            <div className="absolute bottom-3 left-3">
              <div className="px-3 py-1.5 rounded-lg bg-white/90 backdrop-blur-sm">
            ...
            <div className="absolute bottom-3 right-3">
              <span className="px-2.5 py-1 rounded-lg bg-primary-700/80 text-white text-[11px] font-medium backdrop-blur-sm">
          ...
          {/* Content */}
          <div className="p-4">
            <h3 className="text-base font-semibold text-gray-900 line-clamp-1 group-hover:text-primary-700 transition-colors">
              {property.title}
            </h3>
